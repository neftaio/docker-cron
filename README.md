# docker-cron
A simple docker container that runs a cron invoking a shell script. It was based in the docker cron 
project of cheyer (__https://github.com/cheyer/docker-cron__), extending the installation 
for execute php artisan in laravel applications.
...
## To use with laravel artisan
In the file *script.sh* uncomment the last line and verify the correct path for artisan file.
